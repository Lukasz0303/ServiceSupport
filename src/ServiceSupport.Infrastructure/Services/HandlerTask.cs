...
namespace ServiceSupport.Infrastructure.Services
{
    public class HandlerTask : IHandlerTask
    {
        ...
        private Func<ServiceSupportException, Task> _onCustomErrorAsync;
        private Func<ServiceSupportException, Logger, Task> _onCustomErrorWithLoggerAsync;
        ...
        public IHandlerTask OnCustomError(Func<ServiceSupportException, Task> onCustomError, 
        ...
        public IHandlerTask OnCustomError(Func<ServiceSupportException, Logger, Task> onCustomError, 
            bool propagateException = false, bool executeOnError = false)
        {
        ...
        {
			var customException = exception as ServiceSupportException;
